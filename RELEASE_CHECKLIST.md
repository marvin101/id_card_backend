...
- [ ] The intended target is `d7e4a10b9c82`; the complete migration chain through personnel custom fields/photos, import/grid support, credential compatibility, and downgrade behavior has been reviewed.
